...
function Header() {
  const user = JSON.parse(localStorage.getItem("mushfiqeen-user"));
    ...
    <div className="p-3 bg-primary rounded-md">
      ...
      <div className="flex items-center justify-between">
        <div onClick={() => navigate("/")} className="cursor-pointer">
          <h1 className="text-2xl font-semibold text-white">MUSHFIQEEN</h1>
        ...
        <div className="flex space-x-10 justify-end items-center md:hidden">
            ...
            return (
              <Link
                ...
                className={`text-gray-200 ${
                  ...
                  "bg-white text-gray-900 rounded py-1 px-3"
                }`}
          ...
          <h1
            ...
            onClick={() => {
              localStorage.removeItem("mushfiqeen-user");
              navigate("/login");
            }}
          >
            Logout
