...
function PostDesc() {
  const currentUser = JSON.parse(localStorage.getItem("mushfiqeen-user"));
            ...
            <div className="cursor-pointer h-[550px] w-[550px]">
              ...
              <div className="card-sm p-2 flex w-full items-center space-x-5">
                ...
                <div className="flex space-x-2 items-center">
                  ...
                  />
                  <h1 className="underline text-xl cursor-pointer">
